  ...
  return (
    <div className="page-body">
      ...
      <div className="g4 mb18">
        <MetricCard label="Total Leads Masuk" value="1.842 Leads" trend={14.2} acc="#3B82F6" />
        <MetricCard label="Leads Qualified" value="612 Leads" trend={9.8} acc="#833AB4" />
        <MetricCard label="Closing Rate" value="38.5%" sub="Dari Qualified Prospect" acc="#22C55E" />
        <MetricCard label="Win Rate Total" value="12.8%" sub="Leads to Customer" acc="#C9A84C" />
      </div>
